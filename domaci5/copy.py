...
def prva(fajl):
    ...
    for i in range(len(sortirani_podaci)):
        lista_max=[]
        lista_min=[]
        lista_max.append(max(sortirani_podaci,key=lambda i:sortirani_podaci[i]))
        #lista_min.append(min(sortirani_podaci,key=sortirani_podaci.get(sortirani_podaci)))
